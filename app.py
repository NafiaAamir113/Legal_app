...
# Load secrets from Streamlit's secrets
...
try:
    ...
    st.warning("⚠️ Could not load 'BAAI/bge-large-en'. Using fallback model 'all-MiniLM-L6-v2'.")
    try:
...
if st.button("Generate Answer"):
    ...
    # Simple heuristic for incomplete queries
